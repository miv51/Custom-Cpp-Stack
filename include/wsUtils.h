...
const char WS_TEXT_FRAME = constructBaseFrame(1, 0, 0, 0, 0x1); //prints as ü
const char WS_BINARY_FRAME = constructBaseFrame(1, 0, 0, 0, 0x2); //prints as é
const char WS_PING_FRAME = constructBaseFrame(1, 0, 0, 0, 0x9); //if we receive this frame, respond immediately - prints as ë
