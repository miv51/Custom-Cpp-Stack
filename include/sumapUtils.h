...
template <typename keyDataType, typename valueDataType, size_t N, size_t B>
staticUnorderedMap<keyDataType, valueDataType, N, B>::staticUnorderedMap()
{
...
template <typename keyDataType, typename valueDataType, size_t N, size_t B>
constexpr inline valueDataType& staticUnorderedMap<keyDataType, valueDataType, N, B>::operator[](const keyDataType& key)
{
...
template <typename keyDataType, typename valueDataType, size_t N, size_t B>
constexpr inline bool staticUnorderedMap<keyDataType, valueDataType, N, B>::contains(const keyDataType& key)
{
    size_t hash_value = hash<keyDataType>(key) % B;
...
template <typename keyDataType, typename valueDataType, size_t N, size_t B>
inline void staticUnorderedMap<keyDataType, valueDataType, N, B>::initializeKeys(auto& range_based_container)
{
    length = 0;
